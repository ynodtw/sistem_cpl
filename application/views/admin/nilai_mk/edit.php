					...
					<div class="card-body">
						<form method="POST" action="<?= base_url("nilai_mk/update") ?>" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="n_absen" value="<?= $nilai_mk['n_absen'];  ?>" name="n_absen" value="" placeholder="" required>
							</div>


							<div class="form-group">
								<label for="n_tugas">Nilai Tugas</label>
								<input type="text" class="form-control" id="n_tugas" value="<?= $nilai_mk['n_tugas'];  ?>" name="n_tugas" placeholder="" required>
							</div>

							<div class="form-group">
								<label for="n_uts">Nilai UTS</label>
								<input type="text" class="form-control" id="n_uts" value="<?= $nilai_mk['n_uts'];  ?>" name="n_uts" placeholder="" required>
							</div>

							<div class="form-group">
								<label for="n_uas">Nilai UAS</label>
								<input type="text" class="form-control" id="n_uas" value="<?= $nilai_mk['n_uas'];  ?>" name="n_uas" placeholder="" required>
							</div>
