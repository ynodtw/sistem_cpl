  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-6">
        <div class="card">
          <div class="card-body">
            <form method="POST" action="<?= base_url("tamu/insert") ?>" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="telp" name="telp" placeholder="Masukan No Telp" required>
              </div>
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" id="tujuan" name="tujuan" placeholder="Masukan Tujuan" required></textarea>
              </div>

              <div class="form-group">
                <label for="tgl_datang">Tanggal Datang</label>
                <input type="date" class="form-control" id="tgl_datang" name="tgl_datang" value="<?= date("Y-m-d") ?>" required>
              </div>

              <div class="form-group">
                <label for="tgl_pulang">Tanggal Pulang</label>
                <input type="date" class="form-control" id="tgl_pulang" name="tgl_pulang" value="<?= date("Y-m-d") ?>" required>
              </div>
